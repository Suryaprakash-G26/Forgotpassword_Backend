...
router.post("/register", async (req, res) => {
  try {
    ...
    const encodedToken = encodeURIComponent(activetoken);

    const activateUrl = `${process.env.backend}activate/${encodedToken}`;
    ...
    const activationResult = await Accountactivator(save.email, activateUrl);
